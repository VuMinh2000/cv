...
<body>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            ...
            <p>We're <span class="typed" data-typed-items="<?php
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="assets/img/duga.jpg" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4" data-aos="fade-right">
                        <img src="assets/img/meo.jpg" class="img-fluid" alt="">
                    </div>
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        <h3>WEB DESIGN</h3>
                        <h5>Name: Nguyen Duy Quang</h5>
                        <p class="font-italic">
                            Work hard, Play hard
                        </p>
                        <div>
                            <ul class="row">
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Birthday :</strong> 20 June 2000 </li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Email :</strong> Qu@gmail.com </li>
                                <li class="col-lg-5"><i class="icofont-rounded-right"></i> <strong>Mobile :</strong> 541236</li>
                        ...
                        <p>
                        The phenomenon of indifference, indifference, irresponsibility to relatives and families of the young generation today is a negative expression in the life of young people - the future owners of the country. This phenomenon attracts new relationships and causes many frustrations for society.                        </p>
                    </div>
                </div>
...
<br>
                ...
                <div class="row skills-content">
                <p class="font-italic">
                        <h5>Name: Duy Quang</h5>
                        </p>
                    <div class="row col-lg-12" data-aos="fade-up">

           
                    <div class="progress col-lg-6">
                            <span class="skill">SOCCER <i class="val">60%</i></span>
                            <div class="progress-bar-wrap">
                        ...
                        <div class="progress col-lg-6">
                            <span class="skill">Workin'Grp <i class="val">50%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="progress col-lg-6">
                            <span class="skill">PHP <i class="val">66%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="progress col-lg-6">
                            <span class="skill">JAVASCRIPT <i class="val">77%</i></span>
                            <div class="progress-bar-wrap">
...
<!-- 
                <div class="progress col-lg-6">
                            <span class="skill">SOCCER <i class="val">100%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
